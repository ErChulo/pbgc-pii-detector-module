...
replace only sensitive values with neutral placeholders: `[REDACTED]` or
`[ERASED]`. The manifest records whether the archive was password-protected,
whether export was blocked, detector validation evidence, policy references, and
